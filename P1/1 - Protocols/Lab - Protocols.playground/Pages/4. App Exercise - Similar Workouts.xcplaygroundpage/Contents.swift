...
let maraton = RunningWorkout(distance: 123, time: 89)
let carreraAcuatica = SwimmingWorkout(distance: 278, time: 743)

simpleWorkoutDescription(workout: maraton)
simpleWorkoutDescription(workout: carreraAcuatica)
